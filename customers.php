                      ...
                      <div id="customermodal" class="w3-modal">
                        <div class="w3-modal-content w3-animate-top w3-card-4">
                          ...
                          <div style="float:right;">
                            <input class="customerid deactivated" style="text-align: center;" type="text" data-noreset="true" value="'.$row['id'].'" readonly>
                          </div>
                          <div class="customer-container" id="customercontainer">
                            ...
                            <div class="row">
                              ...
                              <?php
                              $sql = "SELECT * FROM orders WHERE customer_id = '.$row['id'].'";
                              ...
                              <option value="'.$order['id'].'"><'.$order['first_update'].'</option>
                              <?php } ?>
                              </select>
                              </div>
