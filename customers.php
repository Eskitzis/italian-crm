              ...
              $sql = 'SELECT * FROM customers';
                ...
                // Output data of each row
                  while($row = $result->fetch_assoc()) {
                    ...
                    echo '<button id="menupopup" class="cell-more-button " onclick="moreoptions(' . $row['id'] .' '. $row['firstname'] . ')"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg></button>';
