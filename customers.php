          ...
          <div class="customer-container" id="customercontainer">
            ...
            <div class="row">
              <div class="column left">
                <?php
                  $sql = "SELECT orders.first_update FROM orders JOIN customers WHERE customer_id.orders = id.customers";
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Customer Order' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'GRUPPOCASA->FACTORY' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'FACTORY->CUSTOMER (PROFORMA)' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'GRUPPOCASA->CUSTOMER (PROFORMA)' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'CUSTOMER->GRUPPOCASA (CONFIRMATION)' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'GRUPPOCASA->FACTORY (CONFIRMATION)' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Advance payment 1' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Advance payment 2' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>               
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Invoices' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Final payment' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>                
                ...
                <div class="detailed-order">
                  ...
                  <?php
                    $sql = "SELECT * FROM order_status WHERE order_status = 'Order Shipped' AND customer_id_status = '1'";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    echo '<span class="span-customer">'.$row['order_update'].'</span>';
                  ?>
