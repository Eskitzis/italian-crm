        ...
        <div class="app-content">
          ...
          <div class="products-area-wrapper tableView">
            ...
            <div class="flex-item-three">
              <canvas id="orderstatuschart" style="width:50%;text-align: center;max-width:400px"></canvas>
              <canvas id="ordersfulfilled" style="width:50%;text-align: center;max-width:400px"></canvas>                                      
            </div>
        </div>
      </div>
      <script>
