        ...
        <div class="app-content">
          ...
          <div class="products-area-wrapper tableView">
                      ...
                      // Output data of each row
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo '<span class="leaderboard__value">';
                            ...
                            echo '<span class="leaderboard__name" style="text-align:right;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg></span>';
                          echo '</article>';
                        }
                      }
                    ?>
                      ...
                      // Output data of each row
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo '<span class="leaderboard__value">';
                            ...
                            echo '<span class="leaderboard__name"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg></span>';
                          echo '</article>';
                        }
                      }
                    ?>
            ...
            <div class="flex-item-three">
              <canvas id="orderstatuschart" style="width:50%;max-width:400px"></canvas>
              <canvas id="ordersfulfilled" style="width:50%;max-width:400px"></canvas>                                      
            </div>
        </div>
      </div>
      <script>
